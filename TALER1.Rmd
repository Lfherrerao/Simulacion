...
grafico1<-ggplot(data=langostinos, aes (x = hembras))+
  ...
  labs(title = "GRAFICA DE HEMBRAS", x = "TAMAÑO", y="FRECUENCIA",caption = "1. En la grafica de las hembras \n se puede evidenciar que es leptocurtica negativa y que segun sus distribuciones......")
...
grafico2<-ggplot(data=langostinos, aes (x = machos))+
  ...
  labs(title = "GRAFICA DE MACHOS", x = "TAMAÑO", y="FRECUENCIA")
...
b. El promedio de los  tamaños de langostinos hembras es de:189.0667 y el promedio de los tamaños de los langostinos machos es de 154.4667.
```{r,echo=FALSE}
mean(hembras)
mean(machos)
```
...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
#a. ¿Cuántos de los habitantes de la pequeña ciudad superarán previsiblemente los 92 
